...
const Bio = () => {
  return (
    <div className="flex w-[60vw] flex-col gap-12 lg:flex-row mt-16 bg-red-400">
      <img
        src={aboutPic}
        alt="coder-art"
        className="w-full h-[30vh] md:w-[30vw] self-center"
      />
      <div className="flex flex-col self-center w-[80vw] text-center md:w-[70vw] bg-slate-400">
